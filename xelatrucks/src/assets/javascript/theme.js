      ...
      _createClass(DataTablesDemo, [
        {
          ...
          value: function init() {
            ...
            this.table
              .buttons()
              .container()
              .appendTo("#dt-buttons3");
          }
        },
        {
          key: "table",
          value: function table() {
            return $("#myTable3").DataTable({
              dom:
                "<'text-muted'Bi>\n        <'table-responsive'tr>\n        <'mt-4'p>",
              buttons: [
                {
        ...
        },
        {
          ...
          value: function searchRecords() {
            ...
            $("#table-search2, #filterBy2").on("keyup change focus", function (
              ...
              // console.log('2');
              var filterBy = $("#filterBy3").val();
              var hasFilter = filterBy !== "";
              var value = $("#table-search3").val(); // clear selected rows
